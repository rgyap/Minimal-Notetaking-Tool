...
public final class ReadAndConvert {

    private ReadAndConvert() {
    }
    ...
    public static void writeConvertedLines(ArrayList<String> convLines, String name, Path targetpath) {
        try {
            Files.write(targetpath, convLines);
        } catch (IOException e) {
            System.out.println(e);
        }
    }
